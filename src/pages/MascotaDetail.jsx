      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden dark:bg-gray-800 mb-8">
          ...
          <div className="p-6 md:p-8 text-gray-800 dark:text-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                <h2 className="text-xl font-semibold mb-2 text-indigo-600 dark:text-blue-300">Información de Contacto</h2>
              ...
              <div>
                <h2 className="text-xl font-semibold mb-2 text-indigo-600 dark:text-blue-300">Horario de Atención</h2>
            ...
            <div className="mb-6">
              <h2 className="text-xl font-semibold mb-2 text-indigo-600 dark:text-blue-300">Descripción</h2>
              <p className="text-lg leading-relaxed">{refugio.description}</p>
            </div>

            <div>
              <h2 className="text-xl font-semibold mb-2 text-indigo-600 dark:text-blue-300">Proceso de Adopción</h2>
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-3xl font-bold text-indigo-700 dark:text-blue-400">Mascotas en este refugio</h2>
